...
const Testimonialitems = ({ src, title, name, children }) => {
  return (
    <div className="pt-28 pb-14 w-[1000px] m-auto bg-white rounded-3xl relative mt-20 shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px] mb-8">
      ...
      <p className="text-[#726E9E] font-poppins font-medium text-2xl w-[700px] text-center leading-10 m-auto mt-8 mb-12">
        {children}
      </p>
